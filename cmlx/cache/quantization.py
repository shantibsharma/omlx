...
"""
Dynamic KV Cache Quantization for cMLX.
...
def quantize_kv_block(
    ...
    for layer in cache_data:
        ...
        quantized_data.append(('__cmlx_quant_v1__', (qk, qv, sk, sv, bk, bv)))
...
def dequantize_kv_block(
    ...
    Auto-detects format based on the tag:
        - '__cmlx_quant_v1__': INT8 affine quantization
        - '__cmlx_fp8_v1__': FP8 E4M3 quantization
