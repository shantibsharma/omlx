...
"""
Engine pool for cMLX multi-model serving.
...
from .c_bindings import fast_cache_warmup, parallel_warmup_dir
...
class EnginePool:
    ...
    def resolve_model_id(self, model_id_or_alias: str, settings_manager) -> str:
        ...
        contains a provider prefix (e.g. "cmlx/my-model"), strips the prefix
        ...
        # Strip provider prefix (e.g. "cmlx/qwen3.5-35b" -> "qwen3.5-35b")
