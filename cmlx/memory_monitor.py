...
"""
Memory Monitor for cMLX paged SSD-based KV cache.
...
if TYPE_CHECKING:
    from cmlx.cache.paged_cache import PagedCacheManager

from cmlx.utils.hardware import get_max_working_set_bytes, format_bytes
