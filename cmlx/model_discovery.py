...
"""
Model discovery for cMLX multi-model serving.
...
SUPPORTED_RERANKER_ARCHITECTURES = {
    ...
    "XLMRobertaForSequenceClassification",  # cmlx native implementation
}
...
# at import time so cMLX automatically recognises new audio model families
    ...
    for subdir in sorted(model_dir.iterdir()):
        ...
        if _is_adapter_dir(subdir):
            logger.info(
                ...
                "(cMLX does not support LoRA/PEFT adapters)"
            )
