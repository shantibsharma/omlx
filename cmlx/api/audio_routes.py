...
# ---------------------------------------------------------------------------
# Engine pool accessor — patched in tests via cmlx.api.audio_routes._get_engine_pool
# ---------------------------------------------------------------------------
...
def _get_engine_pool():
    ...
    Can be replaced in tests via patch('cmlx.api.audio_routes._get_engine_pool').
    """
    # Import here to avoid circular imports at module load
    from cmlx.server import _server_state
...
def _resolve_model(model_id: str) -> str:
    ...
    """
    from cmlx.server import resolve_model_id
...
async def process_audio(
    ...
    """
    from cmlx.engine.sts import STSEngine
    from cmlx.exceptions import ModelNotFoundError
