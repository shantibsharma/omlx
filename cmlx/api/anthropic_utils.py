...
Handles conversion between Anthropic API format and internal cMLX format.
"""
...
def _decode_document_block(block_dict: dict[str, Any]) -> str:
    ...
    cMLX does not provide document parsing.
    """
    ...
    return (
        ...
        f"cMLX does not provide PDF parsing. Send as text instead.]"
    )
