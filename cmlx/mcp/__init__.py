...
"""
MCP (Model Context Protocol) client support for cMLX.

This module provides integration with MCP servers, allowing the cmlx server
to discover and execute tools from external MCP servers.

Example usage:
    from cmlx.mcp import MCPClientManager, load_mcp_config
