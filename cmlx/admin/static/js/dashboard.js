    ...
    function dashboard() {
        return {
            // Theme
            theme: localStorage.getItem('cmlx-chat-theme') || 'auto',
            ...
            // oQ Uploader state
            uploadHfToken: localStorage.getItem('cmlx-hf-upload-token') || '',
            uploadHfUsername: '',
            uploadHfOrgs: [],
            uploadHfNamespace: '',
            ...
            get codexCommand() {
                const cli = this.stats.cli_prefix || 'cmlx';
            ...
            benchBuildText() {
                ...
                lines.push('cMLX - LLM inference, optimized for your Mac');
                lines.push('https://github.com/shantibsharma/cmlx');
            ...
            setTheme(theme) {
                this.theme = theme;
                localStorage.setItem('cmlx-chat-theme', this.theme);
                this.applyTheme();
            },
            ...
            async validateUploadToken() {
                ...
                try {
                    ...
                    if (response.ok) {
                        ...
                        localStorage.setItem('cmlx-hf-upload-token', this.uploadHfToken);
