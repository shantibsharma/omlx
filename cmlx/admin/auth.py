...
"""Authentication utilities for the cMLX admin panel.
...
SESSION_COOKIE_NAME = "cmlx_admin_session"
...
SECRET_KEY = os.environ.get("CMLX_SECRET_KEY") or secrets.token_hex(32)
...
def init_auth(secret_key: str, global_settings_getter=None) -> None:
    ...
    Environment variable CMLX_SECRET_KEY takes priority if set.
    ...
    key = os.environ.get("CMLX_SECRET_KEY") or secret_key
    SECRET_KEY = key
