...
class CMLXError(Exception):
    """
    Base exception for all cMLX errors.

    All custom exceptions in cMLX should inherit from this class to allow
    for easy catching of all cMLX-related errors.
    """
...
class SchedulerError(CMLXError):
...
class ConfigurationError(CMLXError):
    """
...
class CMLXMemoryError(CMLXError):
    """Base exception for memory-related errors."""

    pass


class OutOfMemoryError(CMLXMemoryError):
    """
    Out of memory error.
...
class PrefillMemoryExceededError(CMLXMemoryError):
    """
...
class EnginePoolError(CMLXError):
