"""Configuration management for cMLX menubar app."""
...
def get_app_support_dir() -> Path:
    """Get the Application Support directory for cMLX."""
...
class ServerConfig:
    ...
    base_path: str = str(Path.home() / ".cmlx")
    port: int = 8000
    ...
    def build_serve_args(self) -> list:
        """Build command line arguments for cmlx serve.
