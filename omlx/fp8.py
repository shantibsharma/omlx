...
"""FP8 (float8_e4m3) weight support for oMLX.
...
def fast_fp8_quantize(weight: Any) -> Tuple[Any, Any]:
    ...
    If omlx_fast_io is available, uses the native C++ path which optimizes
...
def quantize_kv_block_fp8(
    ...
    for layer in cache_data:
        ...
        quantized_data.append(('__omlx_fp8_v1__', (qk, qv, sk, sv)))
...
def dequantize_kv_block_fp8(
    ...
    if layer_data[0] != '__omlx_fp8_v1__':
        return layer_data
