...
class TestBuildLayerPattern:
    ...
    def test_freq_2(self):
        from cmlx.patches.index_cache import _build_layer_pattern
...
class TestGetModelType:
    ...
    def test_model_type_attribute(self):
        from cmlx.patches.index_cache import _get_model_type
...
class TestApplyIndexCache:
    ...
    def test_unsupported_model_returns_false(self):
        from cmlx.patches.index_cache import apply_index_cache
    ...
    @patch("cmlx.patches.index_cache._class_patch_applied", True)
...
class TestApplyPostLoadTransforms:
    ...
    def test_none_settings_returns_model(self):
        from cmlx.utils.model_loading import apply_post_load_transforms
    ...
    @patch("cmlx.patches.index_cache.apply_index_cache")
